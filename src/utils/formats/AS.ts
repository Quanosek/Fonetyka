...
function changeGrammar(word: string) {
  ...
  consonantsArray.some((consonant) => {
    ...
    if (word.endsWith('i')) word = word.replaceAll('i' + consonant, 'ii' + consonant)

    // wyjątki z "i"
    if (
      word.includes('i' + consonant) &&
      !(word.startsWith('i') || word.includes('li' + consonant) || word.includes('ri'))
    ) {
  ...
  // wyjątki z "ŋ"
  if (word.includes('ŋ')) {
    if (word.includes('ŋgi') || word.includes('ŋki')) word = word.replace('ŋ', 'ŋʹ')
  ...
  voicelessArray.some((voiceless) => {
    if (word.startsWith('li')) word = word.replace('li' + voiceless, 'lʹi' + voiceless)
    if (
      !(word.includes('cz') || word.includes('sz') || word.includes('rz') || word.includes('dz'))
    ) {
    ...
    if (!word.endsWith(voiceless)) word = word.replace('ą' + voiceless, 'õṇ' + voiceless)
  })
  ...
  voicelessArray.some((voiceless) => {
    if (word.startsWith('l')) word = word.replace('l' + voiceless, 'l̦' + voiceless)
    if (word.startsWith('ł')) word = word.replace('u̯' + voiceless, 'u̯̦' + voiceless)
    if (word.startsWith('m')) word = word.replace('m' + voiceless, 'm̦' + voiceless)
    if (word.startsWith('r')) word = word.replace('r' + voiceless, 'r̦' + voiceless)
  })
  ...
  if (word.includes('χ')) {
    ...
    vowelsArray.some((vowel) => {
      if (word.endsWith(vowel + 'χ')) word = word.replace(vowel + 'χ', vowel + 'h̦')
      if (word.endsWith('χ́' + vowel)) word = word.replace('χ́' + vowel, 'χ́j' + vowel)
    })
    ...
    if (word.startsWith('χ́je') && !word.startsWith('x́jɛ̃')) word = word.replace('χ́je', 'χ́e')
