...
function changeGrammar(word: string) {
  ...
  // wyjątki z "ŋ"
  if (word.includes('ŋ')) {
    if (word.includes('ŋgi') || word.includes('ŋki')) word = word.replace('ŋ', 'ŋʲ')
  ...
  voicelessArray.some((voiceless) => {
    if (word.startsWith('li')) word = word.replace('li' + voiceless, 'lʲi' + voiceless)
    if (
    ...
    if (!word.endsWith(voiceless)) word = word.replace('ą' + voiceless, 'on͇' + voiceless)
  })
  ...
  voicelessArray.some((voiceless) => {
    if (word.startsWith('l')) word = word.replace('l' + voiceless, 'l̥' + voiceless)
    if (word.startsWith('w')) word = word.replace('w' + voiceless, 'w̥' + voiceless)
    if (word.startsWith('m')) word = word.replace('m' + voiceless, 'm̥' + voiceless)
    if (word.startsWith('r')) word = word.replace('r' + voiceless, 'r̥' + voiceless)
  })
  ...
  if (word.includes('x')) {
    ...
    vowelsArray.some((vowel) => {
      if (word.endsWith(vowel + 'x')) word = word.replace(vowel + 'x', vowel + 'h')
      if (word.endsWith('x́' + vowel)) word = word.replace('x́' + vowel, 'x́j' + vowel)
    })
    ...
    if (word.startsWith('x́jɛ') && !word.startsWith('x́jɛ̃')) word = word.replace('x́jɛ', 'x́ɛ')
